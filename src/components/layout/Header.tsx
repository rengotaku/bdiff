      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between h-12">
          ...
          <div className="flex items-center space-x-3">
            {actions}
            <button
              onClick={() => navigate(`/${currentLang}/about#privacy-proof`)}
              className="hidden sm:inline-flex items-center gap-1 text-xs text-green-700 bg-green-50 border border-green-200 rounded-full px-2.5 py-0.5 hover:bg-green-100 transition-colors cursor-pointer"
            >
